variable "unusual_produce_failures_enabled" {
  type    = bool
  default = true
}

variable "unusual_produce_failures_warning" {
  type    = number
  default = 40
}

variable "unusual_produce_failures_critical" {
  type    = number
  default = 50
}

variable "unusual_produce_failures_evaluation_period" {
  type    = string
  default = "last_30m"
}
...
variable "unusual_produce_failures_docs" {
  type    = string
  default = <<EOFF
...
variable "unusual_produce_failures_priority" {
